...
export const USERS = {
  superAdmin: {
    ...
    role: 'super_admin',
    isActive: true,
    passwordHash: '$2b$10$mock-hash-super-admin', // NOSONAR - intentional test credential
  ...
  owner: {
    ...
    role: 'owner',
    isActive: true,
    passwordHash: '$2b$10$mock-hash-owner', // NOSONAR - intentional test credential
  ...
  manager: {
    ...
    role: 'manager',
    isActive: true,
    passwordHash: '$2b$10$mock-hash-manager', // NOSONAR - intentional test credential
    restaurantGroupId: RESTAURANT_GROUP_ID,
    lastLoginAt: null,
    createdAt: new Date('2025-01-01'),
    restaurantAccess: [
  ...
  staff: {
    ...
    role: 'staff',
    isActive: true,
    passwordHash: '$2b$10$mock-hash-staff', // NOSONAR - intentional test credential
    restaurantGroupId: RESTAURANT_GROUP_ID,
    lastLoginAt: null,
    createdAt: new Date('2025-01-01'),
    restaurantAccess: [
